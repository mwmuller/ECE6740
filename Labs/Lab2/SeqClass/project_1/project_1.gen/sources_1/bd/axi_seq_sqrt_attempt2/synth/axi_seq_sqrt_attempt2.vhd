...
--Command     : generate_target axi_seq_sqrt_attempt2.bd
--Design      : axi_seq_sqrt_attempt2
...
entity axi_seq_sqrt_attempt2 is
  port (
  ...
  attribute CORE_GENERATION_INFO of axi_seq_sqrt_attempt2 : entity is "axi_seq_sqrt_attempt2,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=axi_seq_sqrt_attempt2,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of axi_seq_sqrt_attempt2 : entity is "axi_seq_sqrt_attempt2.hwdef";
end axi_seq_sqrt_attempt2;

architecture STRUCTURE of axi_seq_sqrt_attempt2 is
  component axi_seq_sqrt_attempt2_mypi_seq_sqrt_0_0 is
  port (
  ...
  end component axi_seq_sqrt_attempt2_mypi_seq_sqrt_0_0;
  component axi_seq_sqrt_attempt2_axi_seq_sqrt_interfa_0_0 is
  port (
    mclk : in STD_LOGIC;
    clr : in STD_LOGIC;
    btn : in STD_LOGIC_VECTOR ( 3 downto 0 )
  );
  end component axi_seq_sqrt_attempt2_axi_seq_sqrt_interfa_0_0;
  ...
  attribute X_INTERFACE_PARAMETER of s00_axi_aclk_0 : signal is "XIL_INTERFACENAME CLK.S00_AXI_ACLK_0, ASSOCIATED_BUSIF S00_AXI_0, ASSOCIATED_RESET s00_axi_aresetn_0, CLK_DOMAIN axi_seq_sqrt_attempt2_s00_axi_aclk_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
...
axi_seq_sqrt_interfa_0: component axi_seq_sqrt_attempt2_axi_seq_sqrt_interfa_0_0
     port map (
      btn(3 downto 0) => btn_0_1(3 downto 0),
      clr => s00_axi_aresetn_0_1,
      mclk => s00_axi_aclk_0_1
    );
mypi_seq_sqrt_0: component axi_seq_sqrt_attempt2_mypi_seq_sqrt_0_0
     port map (
