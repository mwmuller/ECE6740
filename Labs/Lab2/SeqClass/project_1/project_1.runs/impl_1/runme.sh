...
HD_PWD='F:/MastersProgram/ECE6740/Labs/Lab2/SeqClass/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seqdeta_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seqdeta_top.tcl -notrace
