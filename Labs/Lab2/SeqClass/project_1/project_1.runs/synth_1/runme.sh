...
HD_PWD='F:/MastersProgram/ECE6740/Labs/Lab2/SeqClass/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seqdeta_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seqdeta_top.tcl
