...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot axi_sqrt_bd xil_defaultlib.axi_sqrt_bd -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_sqrt_bd -key {Behavioral:sim_1:Functional:axi_sqrt_bd} -tclbatch cmd.tcl -protoinst "protoinst_files/axi_sqrt_bd.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_sqrt_bd.wdb xsim.dir)
