...
HD_PWD='F:/MastersProgram/ECE6740/Labs/Lab2/Axi_Interface_Seq_Sqrt/Axi_Interface_Seq_Sqrt.runs/axi_sqrt_bd_mypi_axi_seq_sqrt_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_sqrt_bd_mypi_axi_seq_sqrt_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_sqrt_bd_mypi_axi_seq_sqrt_0_0.tcl
