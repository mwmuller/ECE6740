...
HD_PWD='F:/MastersProgram/ECE6740/Labs/Lab2/PartA/Lab2/Lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sqrt.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sqrt.tcl -notrace
