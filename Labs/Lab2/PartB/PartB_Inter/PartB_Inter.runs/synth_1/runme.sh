...
HD_PWD='F:/MastersProgram/ECE6740/Labs/Lab2/PartB/PartB_Inter/PartB_Inter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2_Axi_Int_seq_sqrt_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab2_Axi_Int_seq_sqrt_wrapper.tcl
