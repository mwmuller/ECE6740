...
HD_PWD='F:/MastersProgram/ECE6740/Labs/Lab2/PartB/PartB_Inter/PartB_Inter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2_Axi_Int_seq_sqrt_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab2_Axi_Int_seq_sqrt_wrapper.tcl -notrace
