...
#
# Generated by export_simulation on Mon Feb 05 15:05:45 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './Lab2_Axi_Int_seq_sqrt.sh' script.

./Lab2_Axi_Int_seq_sqrt.sh -reset_run
...
./Lab2_Axi_Int_seq_sqrt.sh -noclean_files

For more information on the script, please type './Lab2_Axi_Int_seq_sqrt.sh -help'.
