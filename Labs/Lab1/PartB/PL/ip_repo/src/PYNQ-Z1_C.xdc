...
get_ports { led[0] }; #IO_L6N_T0_VREF_34 Sch=led[0]
get_ports { led[1] }; #IO_L6N_T0_VREF_34 Sch=led[0]
get_ports { led[2] }; #IO_L6N_T0_VREF_34 Sch=led[0]
get_ports { led[3] }; #IO_L6N_T0_VREF_34 Sch=led[0]
...
#set_property -dict { PACKAGE_PIN uart_rtl_txd  IOSTANDARD LVCMOS33 } [get_ports { ck_io[14] }]; #IO_L18N_T2_13 Sch=ck_a[0]
#set_property -dict { PACKAGE_PIN uart_rtl_rxd   IOSTANDARD LVCMOS33 } [get_ports { ck_io[15] }]; #IO_L20P_T3_13 Sch=ck_a[1]
