...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../tmp_edit_project.gen/sources_1/ip/adder_bd_clk_wiz_0" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../tmp_edit_project.gen/sources_1/ip/adder_bd_clk_wiz_0" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.adder_bd xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.adder_bd -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log adder_bd_sc.so .tmp_log xcelium_lib waves.shm c.obj)
