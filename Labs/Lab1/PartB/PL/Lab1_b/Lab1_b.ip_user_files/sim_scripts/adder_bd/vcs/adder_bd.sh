...
#
# Script generated by Vivado on Sun Jan 21 21:05:44 -0500 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : adder_bd.sh
...
#
# Usage        : adder_bd.sh
#                adder_bd.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                adder_bd.sh [-reset_run]
#                adder_bd.sh [-reset_log]
#                adder_bd.sh [-help]
#
...
#                script (type 'adder_bd.sh -help' for more information).
#
...
# script info
echo -e "adder_bd.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./adder_bd.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../tmp_edit_project.gen/sources_1/ip/adder_bd_clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../tmp_edit_project.gen/sources_1/ip/adder_bd_clk_wiz_0" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.adder_bd xil_defaultlib.glbl -o adder_bd_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./adder_bd_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key adder_bd_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc adder_bd_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./adder_bd.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: adder_bd.sh [-help]\n\
Usage: adder_bd.sh [-step]\n\
Usage: adder_bd.sh [-lib_map_path]\n\
Usage: adder_bd.sh [-reset_run]\n\
Usage: adder_bd.sh [-reset_log]\n\
Usage: adder_bd.sh [-keep_index]\n\
Usage: adder_bd.sh [-noclean_files]\n\n\
