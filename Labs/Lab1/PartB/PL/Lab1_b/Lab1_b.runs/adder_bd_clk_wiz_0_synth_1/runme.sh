...
HD_PWD='F:/ECE6740/Labs/Lab1/PartB/PL/Lab1_b/Lab1_b.runs/adder_bd_clk_wiz_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_bd_clk_wiz_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_bd_clk_wiz_0.tcl
