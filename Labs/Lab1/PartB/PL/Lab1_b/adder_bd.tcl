...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net c_addsub_0_S [get_bd_pins c_addsub_0/S] [get_bd_ports S_0]
  connect_bd_net -net clk_wiz_clk_out1 [get_bd_pins clk_wiz/clk_out1] [get_bd_pins c_addsub_0/CLK]
