...
HD_PWD='F:/MastersProgram/ECE6740/Labs/Lab1/PartA/Lab1/Lab1.runs/uart_bd_design_1_wrapper_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_bd_design_1_wrapper_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_bd_design_1_wrapper_0_0.tcl
