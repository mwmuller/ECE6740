...
HD_PWD='F:/MastersProgram/ECE6740/Labs/Lab1/Lab1/Lab1.runs/uart_bd_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_bd_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_bd_auto_pc_0.tcl
