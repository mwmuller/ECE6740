...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../Lab1.gen/sources_1/bd/uart_bd/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../Lab1.gen/sources_1/bd/uart_bd/ipshared/5765/hdl" \
       +incdir+"../../../../Lab1.gen/sources_1/bd/uart_bd/ipshared/ec67/hdl" \
       +incdir+"../../../../Lab1.gen/sources_1/bd/uart_bd/ipshared/5765/hdl" \
