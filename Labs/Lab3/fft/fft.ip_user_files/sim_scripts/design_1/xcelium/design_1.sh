...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../fft.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../fft.gen/sources_1/bd/design_1/ipshared/5765/hdl" \
       +incdir+"../../../../fft.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../fft.gen/sources_1/bd/design_1/ipshared/5765/hdl" \
