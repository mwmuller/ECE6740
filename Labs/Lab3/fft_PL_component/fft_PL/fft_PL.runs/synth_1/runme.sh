...
HD_PWD='F:/ECE6740/Labs/Lab3/fft_PL_component/fft_PL/fft_PL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fixed_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fixed_top.tcl
