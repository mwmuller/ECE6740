...
HD_PWD='F:/ECE6740/InClass/Calculator/mux/mux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux24by.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux24by.tcl
